    ...
    <>
      <Section flushTop className="pt-20 pb-10">
        <Shell>
          ...
          <h1 className="display mt-6 max-w-[18ch]">A small shop,<br />built to outlast<br />the client.</h1>
        ...
        <Shell>
          <div className="flex items-baseline justify-between gap-10 mb-14">
            <div className="flex flex-col gap-4">
              ...
              <h2 className="h1 max-w-[18ch]">Four principles, written down.</h2>
            </div>
          </div>
          ...
          <div className="flex flex-col border-t border-rule">
            {[
              ...
              <div key={i} className="grid grid-cols-[1fr_3fr] gap-10 py-9 border-b border-rule max-md:grid-cols-1">
      ...
      <Section>
        <Shell>
          ...
          <div className="grid grid-cols-4 gap-10 max-md:grid-cols-2 max-sm:grid-cols-1">
            {team.map((p, i) => (
              <div key={i}>
                <div className="aspect-[3/4] bg-paper border border-rule relative overflow-hidden flex items-center justify-center grayscale">
                   {/* Placeholder background pattern from original style */}
                  ...
                  <span className="mono small text-mid bg-paper px-2 py-1 border border-rule relative z-10">portrait</span>
                </div>
                <div className="mt-4">
                  <div className="font-serif text-[22px] leading-[1.2]">{p.n}</div>
                  <div className="mono small mt-1">{p.r}</div>
                </div>
              </div>
            ))}
          </div>
        ...
        <Shell>
          ...
          <div className="grid grid-cols-4 gap-10 max-md:grid-cols-2 max-sm:grid-cols-1">
            {[
              ...
              <div key={i} className="flex flex-col gap-[10px] py-7 border-t border-rule">
